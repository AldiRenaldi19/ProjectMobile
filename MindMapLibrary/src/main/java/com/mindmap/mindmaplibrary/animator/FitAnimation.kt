...
import com.mindmap.mindmaplibrary.animator.AnimationUtils.START_PROCESS
...
class FitAnimation(
    ...
    override fun animate() {
        val scaleXHolder = PropertyValuesHolder.ofFloat("scaleFactor", startScaleFactor, endScaleFactor)
